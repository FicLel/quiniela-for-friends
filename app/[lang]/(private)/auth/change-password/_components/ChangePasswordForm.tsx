...
import type { ChangePasswordErrorCode, ChangePasswordResult } from '@/auth/auth.types'
...
export default function ChangePasswordForm({ dict, changePasswordAction }: Props) {
