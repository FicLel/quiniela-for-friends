...
import type { LoginErrorCode } from '@/auth/auth.types'

// Basic email regex — validation is defence-in-depth; the real check is server-side.
...
export default function LoginForm() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Client-side guard: reject obviously invalid emails before the network call.
    ...
    startTransition(async () => {
      // login() calls redirect() on success, so if it returns it always failed.
